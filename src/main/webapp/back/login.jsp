	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#captchaImage").click(function(){//点击更换验证码
                    ...
                    url:"${pageContext.request.contextPath}/validationCode";
				...
				<table>
					  ...
					  <tr>
						...
						<tr>
							...
							<td>
								...
								<img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/validationCode" onclick="this.src=this.src+'?='+Math.random()" title="点击更换验证码"/>
							</td>
						</tr>					
					<tr>
						<td>
					...
					<tr>
						...
						<td>
                            ...
                            <input type="submit" onclick="login()" class="loginButton" value="登录">
						</td>
					</tr>
				</tbody></table>
